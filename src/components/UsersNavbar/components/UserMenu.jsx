          ...
          >
            ...
            >
              ...
              <ul>
                <li>
                  <Link
                    className="font-medium text-sm text-gray-500 hover:text-emerald-800 flex gap-x-2 items-center py-1 px-3"
                    to="/"
                    onClick={() => setDropdownOpen(!dropdownOpen)}
                  >
                    <BellIcon className="text-gray-400 h-5" />
                ...
                <li>
                  ...
                  >
                    <LogoutIcon className="text-gray-400 h-5" />
                    <span>Sign Out</span>
                  </button>
                </li>
              </ul>
